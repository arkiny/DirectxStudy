...
void CrateDemo::DrawScene()
{
	...
	ID3DX11EffectTechnique* activeTech = Effects::BasicTFX->Light2TexTech;
	...
	for (UINT p = 0; p < techDesc.Passes; ++p)
	{
		...
		Effects::BasicTFX->SetTexTransform(XMLoadFloat4x4(&mTexTransform));
		Effects::BasicTFX->SetMaterial(mBoxMat);
		Effects::BasicTFX->SetDiffuseMap(mDiffuseMapSRV);
